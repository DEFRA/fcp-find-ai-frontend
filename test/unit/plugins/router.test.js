...
const answerRoutes = require('../../../app/routes/answer')
...
jest.mock('../../../app/routes/answer', () => [{ path: '/answer', method: 'GET' }])
...
describe('router plugin', () => {
  test('should register routes when register is called', () => {
    ...
    expect(mockServer.route).toHaveBeenCalledWith([].concat(homeRoutes, answerRoutes, healthyRoutes, healthzRoutes, staticRoutes))
  })
})
